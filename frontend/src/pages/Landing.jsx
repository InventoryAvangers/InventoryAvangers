...
import { apiPost, apiGet, apiErrMsg } from '../api/axios.js';
...
const FEATURES = [
  {
    ...
    desc: 'Track stock levels in real time with low-stock alerts and multi-store support.',
  },
  {
    icon: '🛒',
    colorClass: 'landing-feature-card__icon--blue',
    title: 'Point of Sale',
    desc: 'Fast POS checkout with cash, card, and UPI payments. SKU-based product lookup.',
  },
  {
    icon: '📈',
...
export default function Landing() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(apiErrMsg(err, 'Something went wrong. Please try again.'));
    } finally {
      setSubmitting(false);
    }
  };
    ...
    <div className="landing-page">
      ...
      <nav className="landing-nav">
        <div className="landing-nav__logo">
          <div className="landing-nav__logo-icon">I</div>
          <span className="landing-nav__logo-text">Inventory Avengers</span>
        </div>
        <div className="landing-nav__actions">
          <a href="#request-access" className="landing-btn landing-btn--primary">Request Access</a>
      ...
      <section className="landing-hero">
        <div className="landing-hero__inner">
          ...
          <p className="landing-hero__subtitle">
            A powerful, all-in-one inventory, POS, and reporting platform
            for small and medium businesses — without the enterprise price tag.
          </p>
          <div className="landing-hero__ctas">
            <a href="#request-access" className="landing-btn landing-btn--cta">Request Access</a>
        ...
        <div className="landing-section__inner">
          <div className="landing-section__header">
            ...
            <p className="landing-section__desc">
              From inventory tracking to sales reporting, the platform covers every operational need.
            </p>
          </div>
      ...
      <footer className="landing-footer">
        <p>© {new Date().getFullYear()} Inventory Avengers. All rights reserved.</p>
      </footer>
    </div>
  );
}
